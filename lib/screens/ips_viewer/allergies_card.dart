  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (source) {
      case IpsSource.national:
        allergyList =
            ref.read(ipsModelProvider.select((ips) => ips.allergies)).entries;
        break;
      case IpsSource.vhl:
        allergyList = ref
    ...
    return allergyList.length == 0
        ...
        : ExpansionTile(
            ...
            children: <Widget>[
                ...
                ...allergyList.toList().asMap().entries.map((entry) {
                  final allergy = entry.value.value;
                  return Padding(
                          ...
                          children: [
                            ...
                            Chip(
                                ...
                                backgroundColor: allergy.clinicalStatus?.coding?[0].code.toString() == 'active'
                                    ...
                                    : (allergy.clinicalStatus?.coding?[0].code.toString() == 'resolved' ? Theme.of(context).colorScheme.tertiary : Theme.of(context).colorScheme.error))
                          ],
                        ),
                      ]));
                })
