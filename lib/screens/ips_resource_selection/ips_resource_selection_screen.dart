        ...
        body: Padding(
            ...
            child: Column(
                ...
                children: [
                    ...
                    SliverFillRemaining(
                        ...
                        child: ListView(children: <Widget>[
                          ...ref
                              ...
                              .entries
                              .map((conditionEntry) => CheckboxListTile(
                                    controlAffinity:
                                    ...
                                    subtitle: Padding(
                                        padding: const EdgeInsets.fromLTRB(
                                            0, 10, 0, 0),
                                        child: Text(
                                          conditionEntry.value.code?.coding?[0]
                                                  .display ??
                                              '',
                                          style: TextStyle(
                          ...
                          ...ref
                              .read(ipsModelProvider
                                  .select((ips) => ips.allergies))
                              .entries
                              .map((allergyEntry) => CheckboxListTile(
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                                    ...
                                    subtitle: Padding(
                                        padding: const EdgeInsets.fromLTRB(
                                            0, 10, 0, 0),
                                        child: Text(
                                          allergyEntry.value.code?.coding?[0]
                                                  .display ??
                                              '',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold),
                          ...
                          ...ref
                              ...
                              .asMap()
                              .entries
                              .map((medInfoEntry) => CheckboxListTile(
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                          ...
                          ...ref
                              ...
                              .entries
                              .map((immunizationEntry) => CheckboxListTile(
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                  ...
                  SizedBox(height: 15),
                  FilledButton(
                      onPressed: _generateFilteredIPS,
